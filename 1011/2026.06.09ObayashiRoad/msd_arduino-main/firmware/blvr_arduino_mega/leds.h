...
//
//   RED    : blinks on low battery, otherwise solid while relay is OFF.
...
//   YELLOW : solid/blink while YCON source is selected.
//
...
struct LedState
{
  uint8_t  active_src   = 0;   // CTRL_SRC_JETSON / CTRL_SRC_SBUS / CTRL_SRC_YCON
  bool     estop        = false;
